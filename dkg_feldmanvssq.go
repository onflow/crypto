...
// is implemented to qualify or disqualify the dealer if they misbehave.
//
...
// using a public verification vector shared by the dealer and may
// broadcast complaints against a misbehaving dealer.
// The dealer may reply to a complaint by broadcasting
// a complaint answer. The protocol terminates with all honest participants
// reaching consensus on whether the dealer should be disqualified,
