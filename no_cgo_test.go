...
func TestNoRelicPanic(t *testing.T) {
	...
	assert.Panics(t, func() { _ = crypto.IsErrBLSAggregateEmptyList(nil) })
	assert.Panics(t, func() { _ = crypto.IsErrInvalidSignature(nil) })
	assert.Panics(t, func() { _ = crypto.IsErrNotBLSKey(nil) })
